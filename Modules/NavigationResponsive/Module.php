<?php
/**
 * Add responsiveness to navigation
 *
 * @package DtCr
 */

namespace DtCr\Modules\NavigationResponsive;
...
class Module extends ModuleBase implements ManagableModuleInterface {
	...
	public static function get_title() {
		return __( 'Responsive Navigation', 'dt-cr' );
	}

	public static function get_label() {
		return __( 'Add responsiveness settings to Navigation block.', 'dt-cr' );
	}
}
